...
public:
    ...
    // Full paths written so far by the current/last export, in export order —
    // includes fallback naming (unnamed marks, MP4-remux retry) the UI can't
    // predict. Returns a guarded copy, safe to call while exporting.
